...
<div class="site-section  pb-0 py-2">
    <div class="container">
                ...
                <div class="box h-100 card-light p-2 radi shadow">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="text pl-3">
                            ...
                            <h3><a href="#" class="prim">Emerging Trends in IT</a></h3>
                            ...
                            <p class="meta">
                                <span class="mr-2 mb-2">3hr 5m</span>
                                <span class="mr-2 mb-2">Advanced</span>
                                <span class="mr-2 mb-2">Mar 18, 2021</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="box small h-100">
                    <div class="d-flex card-light align-items-center mb-2 p-2 radi shadow">
                        ...
                        <div class="text pl-2">
                            ...
                            <h5><a href=""  class="prim">Data Warehousing</a></h5>
                        </div>
                    </div>
                    <div class="d-flex card-light align-items-center mb-2 p-2 radi shadow">
                        ...
                        <div class="text pl-2">
                            <a href=" " class="category black">Tutorial</a>
                            <h5><a href="" class="prim">Information Systems</a></h5>
                        </div>
                    </div>
                    <div class="d-flex card-light align-items-center p-2 radi shadow">
                        ...
                        <div class="text pl-2">
                            <a href=" " class="category black">Tutorial</a>
                            <h5><a href=" " class="prim">E-commerce</a></h5>
                        </div>
                    </div>
                </div>
            </div>
